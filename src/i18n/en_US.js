module.exports = {
  ...
  pages: {
    ...
    policy: {
      pageTitle: 'Terms and Policy',
      terms: [
        {
          title: 'Cancellation Policy',
          content: 'We understand that plans change, so please take care to note our policy:<br><br>Cancel up to 7 days before check in and get a 50% refund (minus service fees). Cancel within 7 days of your trip and the reservation is non-refundable. Service fees are refunded when cancellation happens before check in and within 48 hours of booking.'
        },
        {
          title: 'Payment Policy',
          content: 'The website collects payment of basic room bookings, however there will be an additional 10% Tourism Tax for those who do not hold a Malaysian passport to be settled in cash at the resort. This fee and any additional costs for extra mattresses, meals and tour packages will be settled in cash at the resort, so please come prepared with cash as there are no ATMs on this side of paradise!'
        }
      ],
      remark: 'Please note that the property does not accept payment via Amex.<br>A tourist tax of RM 10 per room per night is applied to all foreign guests. This tax is not included in the room rate and must be paid upon check-in. Guests with a valid Malaysian Identity Card or valid permanent residents MY PR Card are exempted.'
    }
  },
  datePicker: {
    night: 'Night',
